...
/* harmony import */ var _calendar_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calendar.css */ "./src/main/scripts/calendar.css");
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var this_month = dayjs__WEBPACK_IMPORTED_MODULE_4__(new Date()).locale('ja').format('YYYY-MM');
    var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarEl, {
        plugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__.default, _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_1__.default],
        headerToolbar: {
